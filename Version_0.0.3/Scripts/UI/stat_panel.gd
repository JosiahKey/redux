...
@onready var  acc_label = $Stat_Grid/Accuracy_Stat_Label/stat_num
@onready var  eva_label = $Stat_Grid/Evasion_Stat_Label/stat_num
@onready var  pdr_label = $Stat_Grid/PDR_Stat_Label/stat_num
@onready var  spd_label = $Stat_Grid/Speed_Stat_Label/stat_num
